      ...
      <main className="flex-1 container mx-auto px-4 md:px-6 py-8">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            It may include your computer’s Internet Protocol (IP) address, your browser type and version, the pages you
            visit, the time and date of your visit, the time spent on each page, and other details.
          </p>
          <h3>Device data</h3>
          <p>
          ...
          <ul>
            <li>
              It’s necessary for the performance of a contract to which you are a party or to take steps at your request
              before entering into such a contract (for example, when we provide a service you request from us);
            </li>
            <li>
              It satisfies a legitimate interest (which is not overridden by your data protection interests), such as
              for research and development, to market and promote our services, and to protect our legal rights and
              interests;
            </li>
            <li>
          ...
          <p>
            ...
            your mind at any time (but this will not affect any processing that has already taken place).
          </p>
          <p>
          ...
          <ul>
            ...
            advertising providers, professional advisors and payment systems operators;</li>
          ...
          <p>
            The personal information we collect is stored and processed in United States, or where we or our partners,
            affiliates and third-party providers maintain facilities. By providing us with your personal information,
          ...
          <p>
            ...
            holding, using and disclosing your personal information in accordance with this privacy policy. You do not
            have to provide personal information to us, however, if you do not, it may affect your use of this website
          ...
          <p>
            ...
            change your mind at any time by contacting us using the details below. If you ask us to restrict or limit
            how we process your personal information, we will let you know how the restriction affects your use of our
          ...
          <p>
            ...
            will provide this information in CSV format or other easily readable machine format. You may request that we
          ...
          <p>
            ...
            of our investigation and the steps we will take to deal with your complaint. You also have the right to
          ...
          <p>
            ...
            (including marketing communications), please contact us using the details below or opt-out using the
          ...
          <p>
            If we make a significant change to this privacy policy, for example changing a legal basis on which we
          ...
          <p>This policy is effective as of 23 May 2024.</p>
        </div>
      </main>
      <Footer />
    </div>
